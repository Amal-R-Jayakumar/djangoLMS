...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='StudyCenterCart',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('price', models.DecimalField(decimal_places=2, max_digits=10)),
                ('number_of_students', models.IntegerField(default=0)),
                ('college', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='college_or_atc.studycenter')),
                ('study_center_admin_user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
